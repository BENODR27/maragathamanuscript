    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter">{{count(auth()->user()->unreadNotifications)>0?count(auth()->user()->unreadNotifications):''}}</span>
            </a>
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                @if(count(auth()->user()->unreadNotifications)>0)
                <a class="dropdown-item text-center small text-gray-500" href="{{route('mark-as-read')}}">Mark All As Read</a>
                @endif
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle"
                    src="{{Auth::user()?  Storage::disk('s3')->url('profile/thumbnail/'.Auth::user()->profile_image_name):"" }}">
            </a>
