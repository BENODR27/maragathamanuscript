     ...
     <div class="card-body">
        <form action="{{route('category.update',['category_id'=>$category->id])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <textarea required value="{{$category->description}}" maxlength="50" minlength="10"  name="description" placeholder="" class="form-control" oninvalid="this.setCustomValidity('Enter Valid Description')" oninput="this.setCustomValidity('')">{{$category->description}}</textarea>
          ...
          <div class="mb-3" id="uploaded_image_div" >
              ...
              <img id="uploaded_image" src="{{asset($category->category_image_name)}}" alt="Uploaded Image" style="max-width: 100px;">
          </div>
            <div class="mb-3">
