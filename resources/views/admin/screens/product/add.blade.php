          ...
          <form action="{{ route('product.save') }}" method="post" enctype="multipart/form-data">
             ...
             <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <select required name="product_type" class="form-select form-control" id="product_type" aria-describedby="categoryIdHelp">
            ...
            <div class="mb-3">
              ...
              <input required type="file" name="poster_image" class="form-control" id="poster_image" aria-describedby="posterImageHelp">
          </div>
          <div class="mb-3" id="uploaded_image_div" style="display: none;">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                  ...
                  <input required type="text" name="title" class="form-control" id="title" aria-describedby="nameHelp">
              </div>
            ...
            <div class="mb-3" id="priceDiv">
              ...
              <input required type="number" value="0" name="price" class="form-control" id="price" aria-describedby="priceHelp">
          </div>
         ...
         @if($category->category_type=="audio_video")
          <div class="video-section">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="audio_video_url" class="form-control" id="audio_video_url" aria-describedby="nameHelp">
            </div>
