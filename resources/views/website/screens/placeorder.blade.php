                                ...
                                <div class="row">
                                 ...
                                 <input type="text" name="name" value="{{Auth::user()->name}}" placeholder="Your Name" />
                                  ...
                                  <label class="fieldlabels">Mobile.: *</label>
                                   <input type="text" name="mobile_number" value="{{Auth::user()->mobile_number}}" placeholder="Eg:9876543210" /> 
                                  <label class="fieldlabels">Email: *</label>
                                   <input type="email" name="email" readonly value="{{Auth::user()->email}}" placeholder="Eg:yourmail@mail.com." />
