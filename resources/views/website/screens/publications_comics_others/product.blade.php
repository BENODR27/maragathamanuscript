              ...
              <div class = "product-content mt-5">
                 ...
                 <div class="row mt-2 mt-md-4">
                  ...
                  <div class = "purchase-info mt-3">
                   ...
                   <a class="btn btn-primary" href="{{asset("work/".$product->e_book_file_name)}}" download="{{$product->title}}.pdf">DOWNLOAD E-BOOK</a>
  ...
  <div class="row m-2 p-md-5" >
    ...
    <form id="commentForm" action="{{route('review.add',['product_id'=>$product->id])}}" method="post">
     ...
     <div class="col-md-12 col-sm-12 mb-3" >
         <div class="card mb-3" >
             <div class="card-body">
               <h5 class="card-title"><img style="height:30px;width:30px;"class="rounded-circle" alt="avatar1" @if(Auth::user()->profile_image_name==null) src="{{asset('img/undraw_profile.svg')}}" @else src="{{ Storage::disk('s3')->url('profile/thumbnail/'.Auth::user()->profile_image_name) }}" @endif /> &nbsp {{ Auth::user()->name }}</h5>
                 <div class="row">
                     <div class="col">
