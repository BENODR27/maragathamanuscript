        ...
        <div class="container">
            <div class="row ">
              <div class="row">
                   ...
                   <div class="btn btn-primary col-3 tamilbutton" data-id="1">TAMIL</div>
               
                   <div class="btn btn-primary col-3 englishbutton" data-id="2">ENGLISH</div>
            ...
            {{-- <div class=" pt-4">
                <ol class="list-group list-group-numbered">
                  ...
                  <a class="defaultlist {{$product->language}}" id="{{$product->department_id}}" href="{{route('category.publications_comics_others.product',['product_id'=>$product->id])}}" >
                  ...
                  <div class="row gx-5 gy-4">
                      <div class="col-md-12">
                          <div class="row row-cols-2 row-cols-md-4 gx-4 gy-4">
                              ...
                              <div class="col segment-product defaultlist {{$product->language}}" id="{{$product->department_id}}">
